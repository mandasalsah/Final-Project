...
class WishlistDetailMenuWidget extends StatefulWidget {
  final WishListProduct product;
  const WishlistDetailMenuWidget({super.key, required this.product});

  @override
  State<WishlistDetailMenuWidget> createState() =>
      _WishlistDetailMenuWidgetState();
}

class _WishlistDetailMenuWidgetState extends State<WishlistDetailMenuWidget> {
  @override
